...
🚀 Позже, успешно попробовал свои силы на фриланс-бирже, после чего получил предложение о работе над большим проектом в качестве верстальщика.

🎯 Стремлюсь создавать сложные, удобные и красивые страницы для каждого человека.

---

### $\color{Lightgreen}\Large\textbf{Примеры работ}$
...
🌱 В данный момент в поиске интересных проектов и открыт для любых предложений.
